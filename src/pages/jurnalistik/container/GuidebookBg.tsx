...
export const GuidebookBackgroundjurnalistik = () => {
  return (
    <div className='absolute flex flex-col w-full h-full'>
      <div className='relative flex-1'>
        {/* Desktop */}
        <NextImage
          src='/jurnalistik/guide-left-pattern.png'
        ...
        />
        <NextImage
          src='/jurnalistik/guide-right-pattern.png'
          alt='pattern illustration'
          width='541'
          height='908'
        ...
        />
        <NextImage
          src='/jurnalistik/guide-mobile-right-flower.png'
        ...
        />
        <NextImage
          src='/jurnalistik/guide-mobile-left-flower.png'
          alt='flower illustration'
          width='28'
          height='43'
        ...
        />
        <NextImage
          src='/jurnalistik/guide-mobile-bottom.png'
          alt='pattern illustration'
          width='390'
          height='254'
      ...
      <NextImage
        src='/jurnalistik/guide-bottom.png'
      ...
      />
      <NextImage
        src='/jurnalistik/guide-bottom-mobile.png'
        alt='guide illustration'
        width='780'
        height='325'
