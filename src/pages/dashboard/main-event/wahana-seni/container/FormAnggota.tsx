    ...
    <div className='space-y-6'>
      {fields.map((field, index) => (
        <div key={field.id} className='space-y-0'>
          ...
          <div
            className={clsxm(
              'space-y-6 p-6 rounded-xl bg-white shadow-pendaftaran',
          ...
          >
            <div className='space-y-4'>
              ...
              <Input
                ...
                helperText={
                  index === 0 ? 'Kamu akan otomatis menjadi ketua kelompok' : ''
                }
              ...
              />
              <SelectInput
                id={`team_member.${index}.departemen`}
              ...
              <Input
                id={`team_member.${index}.kontak_aktif`}
                label='Kontak Aktif'
