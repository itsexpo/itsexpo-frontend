...
import { timelineRobotik } from '@/contents/pre-event/robotik/tampilan-awal';
      ...
      <div className='relative w-full grid grid-cols-1 md:grid-cols-6 gap-12 md:gap-6'>
        ...
        <div
          className={clsxm(
            ...
            'md:top-4 md:w-full md:max-w-full md:h-fit md:py-0'
          )}
        >
        ...
        {/* Timeline */}
        {timelineRobotik.map((content, index) => (
          <div
            key={index}
